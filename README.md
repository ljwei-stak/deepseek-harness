...
- [Windows x64 installer](https://github.com/ljwei-stak/deepseek-harness/releases/latest/download/DeepSeek-Harness-ModelRouter-GALGame-Setup-0.4.13-Windows-x64.exe)
- [Debian/Ubuntu `.deb`](https://github.com/ljwei-stak/deepseek-harness/releases/latest/download/DeepSeek-Harness-ModelRouter-GALGame-0.4.13-Linux-amd64.deb)
- [Fedora/RHEL/openEuler `.rpm`](https://github.com/ljwei-stak/deepseek-harness/releases/latest/download/DeepSeek-Harness-ModelRouter-GALGame-0.4.13-Linux-x86_64.rpm)
- [SHA256 checksums](https://github.com/ljwei-stak/deepseek-harness/releases/latest/download/SHA256SUMS-0.4.13.txt)
